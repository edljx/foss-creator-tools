<div align="center">
  ...
  <h1>FOSS Creator Tools</h1>
  <p>A curated list of free and open source tools for video, audio, design, and writing.</p>
</div>

---

**Audience:** Students, advocates, and budget-conscious builders.

**Ditch the subscription, keep the productivity.**

[![License: CC0-1.0](https://img.shields.io/badge/License-CC0%201.0-lightgrey.svg)](http://creativecommons.org/publicdomain/zero/1.0/)
[![Contributions Welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg)](CONTRIBUTING.md)

A curated catalog of free and open source software that lets creators produce video, audio, design, and written work without paying recurring fees to Adobe, Final Cut, Logic, or Canva.
...
* **[free-ai-video-upscaler](https://github.com/sb2702/free-ai-video-upscaler)** — local AI pipeline that upscales and restores low-resolution video using open models.
* **[Jarvis-Desktop-Voice-Assistant](https://github.com/kishanrajput23/Jarvis-Desktop-Voice-Assistant)** — Python desktop voice assistant with speech recognition, TTS, and command execution.
* **[OpenTimelineIO](https://github.com/AcademySoftwareFoundation/OpenTimelineIO)** — interchange format and library for editorial timeline data, supported across NLE and VFX tools.
...
* **[DocumentServer](https://github.com/ONLYOFFICE/DocumentServer)** — self-hosted office suite server with document, spreadsheet, and presentation editors.
* **[bentopdf](https://github.com/alam00000/bentopdf)** — browser-based PDF toolkit for merge, split, compress, convert, and edit.
* **[docling](https://github.com/docling-project/docling)** — document parser that converts PDFs and Office files into structured Markdown and JSON.
* **[Extract2MD](https://github.com/hashangit/Extract2MD)** — utility that extracts content from documents and images into clean Markdown.
...
This catalog is dedicated to the public domain under the [CC0 1.0 Universal License](LICENSE).
